"""
Exercise 1: Basic Model Training (No MLflow)
=============================================

In this exercise, you'll train a sentiment analysis model using Hugging Face Transformers.
This basic version focuses on the core training workflow without experiment tracking.
...
Complete the TODOs below to implement each step.
"""
...
def train_model(model, train_dataset, test_dataset, epochs: int = 2, batch_size: int = 8):
    ...
    # TODO 5: Create TrainingArguments with configuration
    # Hint: Set output_dir="./results", num_train_epochs=epochs,
...
def main():
    ...
    print("=" * 70)
    print("EXERCISE 1: Basic Model Training")
    print("=" * 70)
    print("\nThis script will:")
